...
export const metadata: Metadata = {
  ...
  keywords: ['oficios', 'electricista', 'plomero', 'carpintero', 'servicios', 'profesionales', 'hogar', 'reparaciones'],
  openGraph: {
    title: 'ExpertoCerca - Conecta con Profesionales de Oficios',
    description: 'La plataforma líder para conectar con profesionales de oficios verificados. Encuentra el experto que necesitas para tus proyectos.',
    type: 'website',
