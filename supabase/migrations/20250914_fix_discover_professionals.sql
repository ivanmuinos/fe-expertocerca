-- Fix discover_professionals function - skills column reference
-- The function was trying to access p.skills but that column might not exist
...
-- Also fix browse_professionals for consistency
