-- Update RPC functions to use whatsapp_phone from profiles table as the source of truth
-- This ensures that when users update their WhatsApp in /perfil, it reflects everywhere
