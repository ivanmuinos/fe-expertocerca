    ...
    <div className='w-full flex flex-col justify-center px-2 md:px-3 py-1'>
      ...
      <div className='relative mt-2 w-full'>
        ...
        >
            ...
            >
              {value && (
                <div className='flex items-center gap-2'>
                  <Search className='h-4 w-4 text-muted-foreground' />
                  <span>
                    {value === "all" ? "Todas las profesiones" : value}
                  </span>
                </div>
              )}
            </SelectValue>
          ...
          <SelectContent
            className='max-h-[80vh] overflow-y-auto rounded-xl border border-border/20 shadow-xl bg-background p-4 z-50 w-full min-w-[500px] md:min-w-[600px] data-[state=open]:animate-enter data-[state=closed]:animate-exit'
            align='center'
            side='bottom'
            sideOffset={8}
            position='popper'
