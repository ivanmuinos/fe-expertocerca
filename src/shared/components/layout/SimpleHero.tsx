          ...
          <div className='max-w-4xl mx-auto space-y-6 sm:space-y-8'>
            ...
            <div className='space-y-3 sm:space-y-4'>
              ...
              <p className='text-base sm:text-lg md:text-xl text-white/90 max-w-2xl mx-auto leading-relaxed'>
                Conecta con profesionales calificados en tu área. Desde
                electricistas hasta carpinteros, encuentra el experto que
                necesitas.
              </p>
            </div>
              ...
              <div className='flex flex-wrap gap-2 justify-center'>
                {categories.slice(0, 6).map((category) => (
                  <Button
                    ...
                    size='sm'
                    onClick={() =>
                      navigate(`/buscar?q=${encodeURIComponent(category)}`)
                    }
