...
export default function ProfessionalMiniDetail({ professional }: ProfessionalMiniDetailProps) {
        ...
        <div className="text-center space-y-4 p-8">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground max-w-xs">
              Haz clic en cualquier profesional de la lista para ver sus detalles aquí.
            </p>
          </div>
        </div>
      </div>
  ...
  const handleContactWhatsApp = () => {
    if (professional.whatsapp_phone) {
      const message = encodeURIComponent(`Hola ${professional.profile_full_name}, me interesa tu servicio de ${professional.trade_name}. ¿Podrías brindarme más información?`);
      window.open(`https://wa.me/${professional.whatsapp_phone.replace(/\D/g, '')}?text=${message}`, '_blank');
    }
  };
        ...
        {professional.has_contact_info && (
          <Card className="p-4 bg-muted/50">
            <div className="flex items-center space-x-2 text-sm">
              ...
              <span className="font-medium">Información de contacto disponible</span>
            </div>
