...
export interface LoadingButtonProps
  ...
  asChild?: boolean;
  loading?: boolean; // Local loading override
  loadingText?: string; // Text to show when loading
  showSpinner?: boolean; // Whether to show spinner when loading
}
...
const LoadingButton = React.forwardRef<HTMLButtonElement, LoadingButtonProps>(
  ({ 
    ...
    // Use local loading or global loading
    ...
    const renderContent = () => {
      if (isLoading && showSpinner) {
        const textToShow = loadingText || (typeof children === 'string' ? children : '');
        return (
